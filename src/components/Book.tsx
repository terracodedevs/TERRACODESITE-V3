...
pages.forEach((page) => {
  useTexture.preload(`public/Threejs-Portfolio/textures/${page.front}.jpg`);
  useTexture.preload(`public/Threejs-Portfolio/textures/${page.back}.jpg`);
  useTexture.preload(`public/Threejs-Portfolio/textures/book-cover-roughness.jpg`);
});
...
const Page = ({ number, front, back, page, opened, bookClosed, ...props }: PageProps) => {
  const [picture, picture2, pictureRoughness] = useTexture([
    `public/Threejs-Portfolio/textures/${front}.jpg`,
    `public/Threejs-Portfolio/textures/${back}.jpg`,
    ...(number === 0 || number === pages.length - 1
      ? [`public/Threejs-Portfolio/textures/book-cover-roughness.jpg`]
      : []),
  ]);
