      ...
      <div className="container mx-auto flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col  gap-4 items-center justify-center">
            <div className=" backdrop-blur-md bg-white/10  rounded-full py-4 px-10  w-it text-white shadow-lg flex justify-center items-center flex-row">
                ...
                <h1 className="md:text-2xl ">Code with purpose. Design with impact. Grow with people who care.</h1>
            </div>
            <div className="flex flex-col mt-8 px-24 items-center gap-6 ">
                <h1 className="md:text-6xl font-extralight mb-4 text-[#FDA10A]">Build the Future With Us</h1>
                <p className="md:text-2xl text-neutral-400 text-center">We’re on a mission to craft powerful digital experiences using code, creativity, and AI. Join a team where innovation thrives, learning never stops, and every project is a new opportunity to level up.</p>
