                            ...
                            {filteredPositions.map((project, index) => (
                                ...
                                >
                                    ...
                                    <div className="relative overflow-hidden rounded-lg mb-4">
                                        ...
                                        <div className="absolute inset-0 bg-black/60 backdrop-blur-sm rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-400 flex-col justify-center items-center hidden xl:flex ">
                                            <button 
                                                onClick={() => handleProjectClick(project)}
                                        ...
                                        <div className="absolute inset-0 bg-black/30 rounded-3xl flex flex-col justify-center items-center xl:hidden">
                                            <button 
                                                onClick={() => handleProjectClick(project)}
