...
export default function Hero() {
  return (
    <div>
      <section className="container mx-auto relative w-full h-[20vh] md:h-[40vh] rounded-4xl flex items-center justify-center overflow-hidden font-lufga mt-10 xl:mt-20">
      {/* Background Image */}
      <img
